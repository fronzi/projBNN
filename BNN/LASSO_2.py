...
BilayerProperty = pd.read_csv(path+'P33_tot1.csv',header=0) # read file with bilayers names and target values
...
#
#
df_dataset=pd.read_csv(path+"PLMF.csv",header=0)
#
#
#
